...
<body>
    ...
    <div class="departments-header">
        ...
        <div class = "dept-container">
            <div class ="dept">
                <a href="electric-dept"><h3>ELECTRIC</h3><img src="electric guitar dept.png" alt="electric" width= 281.25px height = 375px></a>
            </div>
            <div class ="dept">
                <a href="acoustic-dept"><h3>ACOUSTIC</h3><img src="acoustic guitar dept.png" alt="acoustic" width= 281.25px height = 375px></a>
            </div>
            <div class ="dept">
                <a href="bass-dept"><h3>BASS</h3><img src="bass dept.png" alt="acoustic" width= 281.25px height = 375px></a>
            </div>
            <div class ="dept">
                <a href="keyboard-piano-dept"><h3>KEYBOARDS/PIANOS</h3><img src="piano dept.png" alt="Piano" width= 281.25px height = 375px></a>
            </div>
            <div class ="dept">
                <a href="ukulele-dept"><h3>AMPS</h3><img src="amp dept.png" alt="amp"width= 281.25px height = 375px></a>
            </div>
            <div class ="dept">
                <a href="Drums-dept"><h3>DRUMS</h3><img src="drums dept.png" alt="Drums" width= 281.25px height = 375px></a>
            </div>
        </div>
