   ...
   <div class="bg-indigo-100 flex rounded-2xl shadow-lg max-w-3xl p-5 items-center">
    <!--Login form-->
      ...
      <div class="mt-3 text-xs flex justify-between-items-center text-indigo-500">
        ...
        <button class="py-1.5 px-5 ml-1 mb-2 bg-white border rounded-xl hover:scale-110 duration-300 text-indigo-500"><a href="<?php echo e(url('registrationpage')); ?>">Register</a></button>
      </div>
   </div>
    <!--Image-->
...
</html><?php /**PATH C:\Users\Kieran\Documents\GitHub\Team-13\resources\views/loginin.blade.php ENDPATH**/ ?>